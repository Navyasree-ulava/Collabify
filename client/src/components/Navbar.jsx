...
const Navbar = ({ setIsSidebarOpen }) => {
    ...
    return (
        <div className="w-full bg-white/80 dark:bg-[#0c0c0e]/80 backdrop-blur-md border-b border-gray-200 dark:border-zinc-800 px-6 xl:px-16 py-3 flex-shrink-0 sticky top-0 z-50">
